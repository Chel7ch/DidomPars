...
<div class="form-row">
  <div class="form-group col-md-3">
    <input type="text" class="form-control" placeholder="Слово" name="english">
  </div>
  <div class="form-group col-md-2">
    <input type="text" class="form-control" placeholder="Транскрипция" name="transcription" >
  </div>
  <div class="form-group col-md-2">
...
<div class="form-row">
  ...
  <div class="form-group col-md-3">
    <input type="text" class="form-control" placeholder="Перевод" name="russian2">
  </div>
</div>
